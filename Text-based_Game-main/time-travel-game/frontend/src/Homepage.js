...
export default function Homepage() {
  ...
  const styles = {
    ...
    getHelpBtn: {
      ...
      fontSize: "1.15em",
      fontFamily: "inherit",
      padding: "0.58em 1.55em 0.58em 1.05em",
      cursor: "pointer",
      marginLeft: "20%",
      marginTop: "0.4em",
      fontWeight: "bold",
      ...
      ...(helpHover ? { transform: "translateY(-2px) scale(1.05)" } : {}),
    },
    helpIcon: {
      fontSize: "1.25em",
      marginLeft: "0.6em",
      marginBottom: "-2px",
      filter: "drop-shadow(0 0 3px #39ff1460)",
    },
    subtitle: {
      color: "#39ff14",
      fontSize: "1.1rem",
    ...
    <div style={styles.body}>
      ...
      <div style={styles.mainContainer}>
        <div style={styles.headerFlex}>
          <div style={styles.terminalHeading}>Cronos Terminal</div>
          <a
          ...
          >
            Get Help <span style={styles.helpIcon} aria-hidden="true">&#x2753;</span>
          </a>
        </div>
        ...
        <div style={styles.descSection}>
          ...
          <p>
            <strong>Cronos Terminal</strong> is a text-based adventure game that lets you explore mysterious places, solve puzzles, and discover hidden treasures. Navigate through legendary locations and use your wits to survive and succeed!
          </p>
